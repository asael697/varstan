...
#'
#' @usage report.default(dat)
#'
#' @export
#'
report.default = function(dat,...){
  cat("This is a generic function for excluded parameters in varstan model")
}
#'  Set the generic function for summary a varstan class
#'
#'  A report of the desired model
#'
#'  @method summary
...
#'  @export
#'
summary = function(model,fit,robust,conf,...){
  UseMethod("summary")
}
#'  Set the generic function for point_estimate a varstan class
#'
#'  A point estimate of a desired model
#'
#'  @method point_estimate
#'
#'  @export
#'
point_estimate = function(model,fit,robust,conf,...){
  UseMethod("point_estimate")
}
#'  Set the generic function for get fitted values in a varstan class
#'
#'  A point estimate of a desired model
#'
#'  @method get_fit
...
#'  @export
#'
get_fit = function(model,fit,robust,...){
  UseMethod("get_fit")
}
#'  Set the generic function for fit in a varstan class
#'
#'  Rstan fit function
#'
#'  @method fit
...
#'  @export
#'
fit = function(model,chains,iter,warmup,adapt.delta,...){
  UseMethod("fit")
}
#'  Set the generic function for fit in a varstan class
#'
...
#'  @export
#'
get_df = function(fit,model,robust,...){
  UseMethod("get_df")
}
#'  Set the generic function for get_residuals in a varstan class
#'
#'  Rstan fit function
#'
