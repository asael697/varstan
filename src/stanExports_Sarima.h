...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(166, 164, "end", "model_Sarima");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Sarima : public prob_grad {
private:
        int n;
        int n1;
        int p;
        ...
        int dinits;
public:
    model_Sarima(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Sarima_namespace::model_Sarima";
        ...
        try {
            ...
            validate_non_negative_index("y", "n1", n1);
            context__.validate_dims("data initialization", "y", "vector_d", context__.to_vec(n1));
            y = Eigen::Matrix<double, Eigen::Dynamic, 1>(n1);
            vals_r__ = context__.vals_r("y");
            pos__ = 0;
            size_t y_j_1_max__ = n1;
            for (size_t j_1__ = 0; j_1__ < y_j_1_max__; ++j_1__) {
                y(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 15;
            validate_non_negative_index("yreal", "n", n);
            context__.validate_dims("data initialization", "yreal", "vector_d", context__.to_vec(n));
            yreal = Eigen::Matrix<double, Eigen::Dynamic, 1>(n);
            vals_r__ = context__.vals_r("yreal");
            pos__ = 0;
            size_t yreal_j_1_max__ = n;
            for (size_t j_1__ = 0; j_1__ < yreal_j_1_max__; ++j_1__) {
                yreal(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 16;
            validate_non_negative_index("xreg", "n1", n1);
            validate_non_negative_index("xreg", "d1", d1);
            context__.validate_dims("data initialization", "xreg", "matrix_d", context__.to_vec(n1,d1));
            xreg = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n1, d1);
            vals_r__ = context__.vals_r("xreg");
            pos__ = 0;
            size_t xreg_j_2_max__ = d1;
            size_t xreg_j_1_max__ = n1;
            ...
            validate_non_negative_index("prior_sar", "P", P);
            validate_non_negative_index("prior_sar", "4", 4);
            context__.validate_dims("data initialization", "prior_sar", "matrix_d", context__.to_vec(P,4));
            prior_sar = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(P, 4);
            vals_r__ = context__.vals_r("prior_sar");
            pos__ = 0;
            size_t prior_sar_j_2_max__ = 4;
            size_t prior_sar_j_1_max__ = P;
            for (size_t j_2__ = 0; j_2__ < prior_sar_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < prior_sar_j_1_max__; ++j_1__) {
                    prior_sar(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            current_statement_begin__ = 23;
            validate_non_negative_index("prior_sma", "Q", Q);
            validate_non_negative_index("prior_sma", "4", 4);
            context__.validate_dims("data initialization", "prior_sma", "matrix_d", context__.to_vec(Q,4));
            prior_sma = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(Q, 4);
            vals_r__ = context__.vals_r("prior_sma");
            pos__ = 0;
            size_t prior_sma_j_2_max__ = 4;
            size_t prior_sma_j_1_max__ = Q;
            for (size_t j_2__ = 0; j_2__ < prior_sma_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < prior_sma_j_1_max__; ++j_1__) {
                    prior_sma(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            ...
            dinits = int(0);
            stan::math::fill(dinits, std::numeric_limits<int>::min());
            stan::math::assign(dinits,(d + (period * D)));
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            validate_non_negative_index("sphi", "P", P);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> sphi(P);
            stan::math::initialize(sphi, DUMMY_VAR__);
            stan::math::fill(sphi, DUMMY_VAR__);
            current_statement_begin__ = 46;
            validate_non_negative_index("stheta", "Q", Q);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> stheta(Q);
            stan::math::initialize(stheta, DUMMY_VAR__);
            stan::math::fill(stheta, DUMMY_VAR__);
            current_statement_begin__ = 49;
            validate_non_negative_index("mu", "n1", n1);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> mu(n1);
            stan::math::initialize(mu, DUMMY_VAR__);
            stan::math::fill(mu, DUMMY_VAR__);
            current_statement_begin__ = 50;
            validate_non_negative_index("epsilon", "n1", n1);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> epsilon(n1);
            ...
            if (as_bool(logical_gt(d1, 0))) {
                ...
                stan::math::assign(mu, rep_vector(0.0, n1));
            }
            ...
            for (int i = 1; i <= n1; ++i) {
                ...
                if (as_bool(logical_gt(P, 0))) {
                    ...
                    for (int j = 1; j <= P; ++j) {
                        current_statement_begin__ = 89;
                        if (as_bool(logical_gt(i, (period * j)))) {
                            current_statement_begin__ = 89;
                            stan::model::assign(mu, 
                                        stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                        (stan::model::rvalue(mu, stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), "mu") + (get_base1(y, (i - (period * j)), "y", 1) * get_base1(sphi, j, "sphi", 1))), 
                                        "assigning variable mu");
                        }
                    }
                }
            ...
            check_greater_or_equal(function__, "phi", phi, -(1));
            ...
            check_greater_or_equal(function__, "theta", theta, -(1));
            check_less_or_equal(function__, "theta", theta, 1);
            current_statement_begin__ = 45;
            size_t sphi_j_1_max__ = P;
            for (size_t j_1__ = 0; j_1__ < sphi_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(sphi(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: sphi" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable sphi: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            check_greater_or_equal(function__, "sphi", sphi, -(1));
            check_less_or_equal(function__, "sphi", sphi, 1);
            current_statement_begin__ = 46;
            size_t stheta_j_1_max__ = Q;
            for (size_t j_1__ = 0; j_1__ < stheta_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(stheta(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: stheta" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable stheta: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            check_greater_or_equal(function__, "stheta", stheta, -(1));
            check_less_or_equal(function__, "stheta", stheta, 1);
            current_statement_begin__ = 49;
            size_t mu_j_1_max__ = n1;
            ...
            if (as_bool(logical_gt(P, 0))) {
                ...
                for (int i = 1; i <= P; ++i) {
                    ...
                    if (as_bool(logical_eq(get_base1(prior_sar, i, 4, "prior_sar", 1), 1))) {
                        ...
                        lp_accum__.add(beta_log(get_base1(Phi0, i, "Phi0", 1), get_base1(prior_sar, i, 1, "prior_sar", 1), get_base1(prior_sar, i, 1, "prior_sar", 1)));
                    }
                }
            }
            ...
            if (as_bool(logical_gt(Q, 0))) {
                ...
                for (int i = 1; i <= Q; ++i) {
                    ...
                    if (as_bool(logical_eq(get_base1(prior_sma, i, 4, "prior_sma", 1), 1))) {
                        ...
                        lp_accum__.add(beta_log(get_base1(Theta0, i, "Theta0", 1), get_base1(prior_sma, i, 1, "prior_sma", 1), get_base1(prior_sma, i, 1, "prior_sma", 1)));
                    }
                }
            }
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("sphi");
        names__.push_back("stheta");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Sarima_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            current_statement_begin__ = 45;
            validate_non_negative_index("sphi", "P", P);
            Eigen::Matrix<double, Eigen::Dynamic, 1> sphi(P);
            stan::math::initialize(sphi, DUMMY_VAR__);
            stan::math::fill(sphi, DUMMY_VAR__);
            current_statement_begin__ = 46;
            validate_non_negative_index("stheta", "Q", Q);
            Eigen::Matrix<double, Eigen::Dynamic, 1> stheta(Q);
            stan::math::initialize(stheta, DUMMY_VAR__);
            stan::math::fill(stheta, DUMMY_VAR__);
            current_statement_begin__ = 49;
            validate_non_negative_index("mu", "n1", n1);
            Eigen::Matrix<double, Eigen::Dynamic, 1> mu(n1);
            stan::math::initialize(mu, DUMMY_VAR__);
            stan::math::fill(mu, DUMMY_VAR__);
            current_statement_begin__ = 50;
            validate_non_negative_index("epsilon", "n1", n1);
            Eigen::Matrix<double, Eigen::Dynamic, 1> epsilon(n1);
            stan::math::initialize(epsilon, DUMMY_VAR__);
            stan::math::fill(epsilon, DUMMY_VAR__);
            ...
            if (include_tparams__) {
                ...
                size_t sphi_j_1_max__ = P;
                for (size_t j_1__ = 0; j_1__ < sphi_j_1_max__; ++j_1__) {
                    vars__.push_back(sphi(j_1__));
                }
                size_t stheta_j_1_max__ = Q;
                for (size_t j_1__ = 0; j_1__ < stheta_j_1_max__; ++j_1__) {
                    vars__.push_back(stheta(j_1__));
                }
                size_t mu_j_1_max__ = n1;
                for (size_t j_1__ = 0; j_1__ < mu_j_1_max__; ++j_1__) {
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < sphi_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "sphi" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t stheta_j_1_max__ = Q;
            for (size_t j_1__ = 0; j_1__ < stheta_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "stheta" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t mu_j_1_max__ = n1;
            for (size_t j_1__ = 0; j_1__ < mu_j_1_max__; ++j_1__) {
...
typedef model_Sarima_namespace::model_Sarima stan_model;
#endif
